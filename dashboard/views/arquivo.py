...
CANONICAS = [
    ...
    ("Novelty · peso fixo w=0,5", "novelty_final",
     "2 cenários (Muro em U, Porta com Alternativa) × 7 execuções, orçamento igualado",
     "QI6 — os 7/7 no Muro em U e o custo simétrico na Porta com Alternativa", None),
    ...
    ("Mega-treino de 1 mês", "mega_1mes",
     "12 fases (Muro em U a n=28 nos 4 braços + ablações)",
