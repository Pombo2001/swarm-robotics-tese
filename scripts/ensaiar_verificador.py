...
MUTACOES = [
    ...
    ("convergência no Muro em U (2/7 a 4/7 -> 2/7 a 5/7)",
    ...
    ("eco da QI6: a magnitude de T4 (77,2 -> 79,2)",
     "superou o peso fixo em magnitude na Porta com Alternativa ($77{,}2$",
     "superou o peso fixo em magnitude na Porta com Alternativa ($79{,}2$", "coerencia"),
    ...
    ("eco das Conclusões: o p de T2 (0,009 -> 0,019)",
     "manteve os 7/7 no Muro em U ($p=0{,}009$ face ao objetivo)",
     "manteve os 7/7 no Muro em U ($p=0{,}019$ face ao objetivo)", "coerencia"),
    ...
    ("eco das Conclusões: o controlo de orçamento (4/7 -> 5/7)",
     "continuou bimodal no Muro em U (4/7)",
     "continuou bimodal no Muro em U (5/7)", "coerencia"),
