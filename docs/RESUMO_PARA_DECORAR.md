...
- Verificação: **27 verificadores**, 19 deles no hook de pre-commit (~965 valores
...
| **A6** | «como sabemos que os números são os dos dados?» | 27 verificadores, 92 mutações, e a cobertura medida com a lista do que falta |
