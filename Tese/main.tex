...
\begin{figure}[!htbp]
    ...
    \caption[Renderizações 3D dos sete cenários de teste]{Renderizações 3D dos sete cenários de teste, geradas a partir da geometria real do simulador (\texttt{scripts/render\_maps.py}). Em cima, da esquerda para a direita: Sandbox, Beco Sem Saída (Muro em U) e Gargalo; ao centro: Quatro Salas, Porta Cooperativa (com a porta destacada a âmbar) e Perceção Cooperativa; em baixo: Porta Cooperativa com Alternativa (\textit{bypass}). A esfera verde assinala o ninho (ou o alvo móvel, na Perceção Cooperativa) e as esferas cinzentas os obstáculos --- densos no Sandbox, esparsos nos restantes. A malha de círculos é a fronteira do domínio, que é uma \textbf{esfera} de raio $15$\,m: o deslocamento dos agentes tem componente vertical, e os obstáculos aparecem nas suas cotas reais, distribuídos pelo volume e não assentes num plano. O anel escuro marca a circunferência de referência $z=0$. Cada parede aparece duas vezes: a preto-azulado, sólida, com altura ilustrativa de $2$\,m para a planta se ler; e em cinzento translúcido, com o volume que ocupa de facto --- de $-15$ a $+15$\,m, ou seja, cortando o domínio de lado a lado. É essa altura que a torna estanque: até 29 de julho de 2026 as paredes tinham $30$\,m fixos numa arena que, no mapa alargado, passara a ter $60$\,m de raio, e os agentes atravessavam-nas por cima.}
...
% seguinte é tudo o que é preciso do lado do LaTeX. Ensaiado a 5 ago com a secção
% incluída: compila em 127 páginas (+6), 0 referências indefinidas e 0 overfull —
% ou seja, o que falta a 16 ago é preencher os \PORPREENCHER com os resultados e
% escolher a leitura A ou B, não descobrir problemas de compilação.
% Falta também, nessa altura: declarar a QI7 na lista de questões (Introdução) e
% acrescentá-la às respostas do Capítulo de Resultados e às Conclusões.
% Se o F2 NÃO fechar a tempo, isto fica como está — a regra 4 dos compromissos de
