...
\begin{itemize}
    \item \textbf{Runs independentes:} Cada combinação (algoritmo, cenário) foi treinada em \textbf{7 execuções independentes} com sementes distintas, nos \textbf{7 cenários} do protocolo ($3 \times 7 \times 7 = 147$ treinos). As curvas reportam a média entre execuções e a banda sombreada o desvio padrão.
