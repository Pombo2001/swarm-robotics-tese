...
\begin{figure}[!htbp]
    ...
    \caption[Vista de topo (planta) dos sete cenários]{Vista de topo (planta) dos sete cenários, evidenciando a geometria das paredes e a largura das passagens. Mesma ordem da Figura~\ref{fig:cenarios_3d}: em cima, Sandbox, Muro em U e Gargalo; ao centro, Quatro Salas, Porta Cooperativa e Perceção Cooperativa; em baixo, Porta Cooperativa com Alternativa.}
