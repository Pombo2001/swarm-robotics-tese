...
\end{itemize}
Os anexos reúnem as configurações e hiperparâmetros (Anexo~\ref{apx:hyperparameters}), os estudos incluídos na revisão sistemática (Anexo~\ref{apx:slr}), o diagrama de classes e os excertos de código mais relevantes (Anexo~\ref{apx:code}), a localização do repositório com o código e os dados (Anexo~\ref{apx:resources}) e a declaração de utilização de ferramentas de inteligência artificial (Anexo~\ref{apx:ia}).
