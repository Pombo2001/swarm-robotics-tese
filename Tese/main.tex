...
A observação de cada agente é estritamente \emph{local e parcial}, garantindo que o sistema opera num regime verdadeiramente descentralizado. Não existe qualquer componente com acesso ao estado global durante a fase de execução, tal como sucede em plataformas físicas de enxame como o Khepera IV ou o e-puck; os sensores simulados são, contudo, idealizados (Secção~\ref{sec:deployment_gap}).
