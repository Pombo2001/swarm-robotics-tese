...
Terceiro, o simulador é tridimensional e este mapa é, na prática, planar: as
paredes vedam toda a altura da arena, e tanto o bónus de exploração como o campo
geodésico que suporta a recompensa de progresso são calculados na projeção
horizontal. Subir não oferece, portanto, atalho nem recompensa --- mas também não
é penalizado, e um controlador que o faça consome orçamento de episódio sem
ganho. Como a arena deste cenário tem quatro vezes o raio da dos sete, o volume
que não contribui para a tarefa é aqui substancialmente maior, o que se soma à
dificuldade de exploração sem acrescentar dificuldade de navegação.
...
A lição é comum às três, e a terceira é o seu caso extremo: um mapa composto não
herda as dificuldades dos cenários que diz compor, e cada uma tem de ser
verificada no ambiente construído --- incluindo as que parecem garantidas pela
geometria. A conectividade do labirinto tinha sido validada por decomposição do
espaço livre, mas num plano, e o espaço em que os agentes se movem não é planar.
